...
Процедура УправлениеФормой(Форма)
	...
	Если (Объект.СпособРасчета = ПредопределенноеЗначение("Перечисление.СпособыРасчетаПоказателейОбъектов.ВыполнитьКод")) Тогда
		
		Элементы.РасчетПоказателейСтраницы.ТекущаяСтраница = Элементы.СтраницаВыполнитьКод;
		
	ИначеЕсли (Объект.СпособРасчета = ПредопределенноеЗначение("Перечисление.СпособыРасчетаПоказателейОбъектов.Запрос")) Тогда

...
// Выполняет расчет значения показателя для коллекции объектов.
// Может запускаться самостоятельно, триггерами или регламентым заданием. 
// 
// Параметры:
// 	Показатель - ПланВидовХарактеристикСсылка.ПоказателиОбъектов - Показатель.
// 	КоллекцияОбъектов - Массив - Коллекция объектов, для которых рассчитываются значения показателя.
// 	ЭтоРегламентноеЗадание - Булево - Признак того, что расчет запускается регламетным заданием
...
// Ищет на показатель по его идентификатору.
// 
// Параметры:
// 	Идентификатор - Строка - Идентификатор показателя.
// Возвращаемое значение:
// 	ПланВидовХарактеристикСсылка.ПоказателиОбъектов, Неопределено - Ссылка на показатель.
// 		Если ссылка не найдена - будет возвращено Неопределено
...
// Идет ссылки показателей по их идентификаторам.
// 
// Параметры:
// 	Идентификаторы - Массив - Идентификаторы показателей.
// Возвращаемое значение:
// 	Соответствие - Найденные показатели. Ключ - идентификатор, значение - ссылка на показатель.
...
// Возвращает значение показателя объекта
// 
// Параметры:
// 	Объект - Произвольный - ссылка на объект.
// 	Показатель - ПланВидовХарактеристикСсылка.ПоказателиОбъектов - Показатель.
// Возвращаемое значение:
// 	Произвольный - Значение показателя объекта.
...
// Возвращает значения показателей для объекта
// 
// Параметры:
// 	Объект - Произвольный - Объект.
// 	КоллекцияПоказателей - Массив - Показатели.
// Возвращаемое значение:
// 	Соответствие - Значения показателей. Ключ - показатель, значение - значение показателя.
...
// 
// Параметры:
// 	КоллекцияОбъектов - Массив - Объекты.
// 	КоллекцияПоказателей - Массив - Показатели
// Возвращаемое значение:
// 	Соответствие - Значения показателей.
//   Ключ - ссылка на объект, значение - соответствие (см. ЗначенияПоказателейОбъекта) 
...
Процедура РассчитатьПоказательВыполнивКод(	ПоказательСтруктура,
											КоллекцияОбъектов = Неопределено,
											Знач ЭтоРегламентноеЗадание = Ложь)
...
Процедура РассчитатьПоказательВыполнивЗапрос(	ПоказательСтруктура,
												КоллекцияОбъектов = Неопределено,
												Знач ЭтоРегламентноеЗадание = Ложь)
